...
- **AI/LLM:** Google Gemini API (version 2.5 Flash Lite for data extraction, version 3.1 Flash Lite Preview for reference), can be configured to use any model supported by Google.
